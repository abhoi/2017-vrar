...
published: true
---
This page declares, defines, and provides an exposition for Project 1 (IN YOUR ROOM) for CS 491 - Virtual and Augmented Reality (Fall 2017) class. There is are lists of objects and sounds used as well as instructions on how to use the application and run it.

A working demonstration of the application can be found at [CS491 ARVR DEMO](https://www.youtube.com/watch?v=t1uqYR1o1rk&feature=youtu.be).
...
![ab_teleportation]({{ site.url }}/assets/project1/ab_teleportation.jpeg)
